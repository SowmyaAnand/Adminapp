...
public class Flyer2Activity extends AppCompatActivity {
    ArrayList<String> second_flyers_id = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flyer2);
        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("ADD IMAGES");
        toolbar.setTitleTextColor(Color.WHITE);
        setSupportActionBar(toolbar);
        second_flyers_id.add("0");
        second_flyers_id.add("0");
        second_flyers_id.add("0");
        second_flyers_id.add("0");
        FirstViewFlyers("2");
        ...
        img12=(ImageView)findViewById(R.id.image1);
        img22=(ImageView)findViewById(R.id.image2);
        img32=(ImageView)findViewById(R.id.image3);
        img42=(ImageView)findViewById(R.id.image4);
        ad1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next = new Intent(Flyer2Activity.this,AddFlyersImage.class);
        ...
        ed1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(second_flyers_id.get(0)=="0")
                {
                    Toast.makeText(Flyer2Activity.this,"PLease an image before making changes ",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Intent next = new Intent(Flyer2Activity.this,AddFlyersImage.class);
                    next.putExtra("flag_flyers", 1);
                    next.putExtra("flyerid",second_flyers_id.get(0));
                    next.putExtra("type","0");
                    startActivity(next);
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId()) {
            case R.id.logout:
                Intent cart = new Intent(Flyer2Activity.this,Login.class);
                startActivity(cart);
                return true;
            case R.id.account:
                Intent account3 = new Intent(Flyer2Activity.this,MyAccount.class);
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if(flagpic1==1)
                {
                    ...
                    img12.setImageURI(resultUri_flyers);
                ...
                else if(flagpic2==1)
                {
                    ...
                    img22.setImageURI(resultUri_flyers);
                }
                else if(flagpic3==1)
                {
                    ...
                    img32.setImageURI(resultUri_flyers);
                }
                else if(flagpic4==1)
                {
                    ...
                    img42.setImageURI(resultUri_flyers);
                }
    ...
    {
        dialog = new ACProgressFlower.Builder(Flyer2Activity.this)
        ...
        ResponseInterface1 mainInterface = retrofit.create(ResponseInterface1.class);
            ...
            call.enqueue(new Callback<ListCategoryResponse>() {
                        ...
                        if(success==1) {
                            ...
                            for (int i = 0; i < data_length; i++) {
                                ...
                                Log.e("Firstpopup.this", "selected flyerid =" + tid);
                                    ...
                                    Log.e("Firstpopup.this", "selected flyerid ="+second_flyers_id);
                                    String imageurl = response.body().getResponsedata().getData().get(i).getImage();
                                    String imageurl_total = url1 + imageurl;
                                    Log.e("flyers", "the succes value is "+img12.getDrawable()+imageurl_total);
                                    if (img12.getDrawable()==null)
                                    {
                                    ...
                                    else if (img22.getDrawable()==null) {
                                        Glide.with(getApplicationContext()).load(imageurl_total)
                                                .diskCacheStrategy(DiskCacheStrategy.ALL)
                                                .into(img22);
                                        ad2.setVisibility(View.GONE);
                                    }
                                    else if (img32.getDrawable()==null) {
                                        Glide.with(getApplicationContext()).load(imageurl_total)
                                                .diskCacheStrategy(DiskCacheStrategy.ALL)
                                                .into(img32);
                                        ad3.setVisibility(View.GONE);
                                    }
                                    else if (img42.getDrawable()==null) {
                                        Glide.with(getApplicationContext()).load(imageurl_total)
                                                .diskCacheStrategy(DiskCacheStrategy.ALL)
                                                .into(img42);
                            ...
                            Toast.makeText(Flyer2Activity.this,"No Data found",Toast.LENGTH_LONG).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                        Toast.makeText(Flyer2Activity.this,"something went wrong",Toast.LENGTH_SHORT).show();
                    }
                ...
                public void onFailure(Call<ListCategoryResponse> call, Throwable t) {
                    ...
                    Toast.makeText(Flyer2Activity.this,t.getMessage(),Toast.LENGTH_SHORT).show();
                }
            });
