            ...
            public void onClick(View v) {
                ...
                else if(id==5)
                {
                    ...
                    else
                    {
                        Intent next = new Intent(FlyersandDeals.this,AddDealsImage.class);
                        next.putExtra("flag_flyers", 1);
                        next.putExtra("dealid",second_flyers_id.get(0));
                        next.putExtra("type","1");
                        startActivity(next);
                    }
                }
            ...
            public void onClick(View v) {
                ...
                else if(id==5)
                {
                    ...
                    else
                    {
                        Intent next = new Intent(FlyersandDeals.this,AddDealsImage.class);
                        next.putExtra("flag_flyers", 1);
                        next.putExtra("dealid",second_flyers_id.get(1));
                        next.putExtra("type","1");
                        startActivity(next);
                    }
                }
                ...
                if(id==3)
                {
                    ...
                    else if(id==5)
                    {
                        ...
                        else
                        {
                            Intent next = new Intent(FlyersandDeals.this,AddDealsImage.class);
                            next.putExtra("flag_flyers", 1);
                            next.putExtra("dealid",second_flyers_id.get(2));
                            next.putExtra("type","1");
                            startActivity(next);
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                else if(id==5)
                {
                    ...
                    else
                    {
                        Intent next = new Intent(FlyersandDeals.this,AddDealsImage.class);
                        next.putExtra("flag_flyers", 1);
                        next.putExtra("dealid",second_flyers_id.get(3));
                        next.putExtra("type","1");
                        startActivity(next);
                    }
                }
    ...
    private void ViewAllDeals()
    {
        ...
        call.enqueue(new Callback<ListCategoryResponse>() {
            ...
            public void onResponse(Call<ListCategoryResponse> call, retrofit2.Response<ListCategoryResponse> response) {
                ...
                int data_length = response.body().getResponsedata().getData().size();
                try {
                    Toast.makeText(FlyersandDeals.this,"response="+success,Toast.LENGTH_LONG).show();
